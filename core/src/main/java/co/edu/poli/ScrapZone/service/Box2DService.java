...
import co.edu.poli.ScrapZone.entity.Player;
...
public class Box2DService {
    ...
    private static final float WIDTH = Main.WIDTH / 10f; // Width of Box2D world.
    private static final float HEIGHT = Main.HEIGHT / 10f; // Height of Box2D world.
